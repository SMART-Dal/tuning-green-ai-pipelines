#!/usr/bin/env python3
"""
Run inference on the BigVul test set using a fine-tuned ModernBERT model.

Usage:
    python inference.py --cfg config/config.yaml --model results/run_name/model --out results/run_name
"""
import os, sys, time
